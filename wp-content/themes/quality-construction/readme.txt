...
= 1.1.1 - April 24 2021 =
* Extend compatibility to WordPress 5.7
* Extend compatibility to Php 8
* Upgraded Bootstrap to 5.0.0beta from 3.3.6 and updated current code to be compatible.
* Upgraded Navwalker latest version to 4.3.0 from 2.0.5
* Fixed layout to ensure compatibility with bootstrap 5.
* Updated Magnific Popup to v1.1.0
* Updated Wow to - v1.1.3
* Added Rankchecker for plugin recommendations.
* Removed bootstrap-dropdownhover library
