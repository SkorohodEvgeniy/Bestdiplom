...
function quality_construction_scripts()
{
    ...
    wp_enqueue_style('animate', get_template_directory_uri() . '/assets/css/animate.css', array(), '4.5.1');

    wp_enqueue_style('magnific-popup', get_template_directory_uri() . '/assets/css/magnific-popup.css', array(), '4.5.1');

    wp_enqueue_style('quality-construction-style', get_stylesheet_uri(), array(), '4.5.1');
    ...
    wp_enqueue_script('quality-construction-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '4.5.1', true);
...
/* Wp-navwalker support for Bootstrap 5 */
 ...
 * Recommended plugins
 *
 * @package Quality Construction
 */
if ( ! function_exists( 'quality_construction_recommended_plugins' ) ) :
    /**
     * Recommend plugins.
     *
     * @since 1.0.0
     */
    function quality_construction_recommended_plugins() {
        $plugins = array(
			
			array(
                'name'     => esc_html__( 'Rankchecker.io Integration', 'quality-construction' ),
...
add_action( 'tgmpa_register', 'quality_construction_recommended_plugins' );
