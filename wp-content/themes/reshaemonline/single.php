...
get_header(); ?>
    ...
    <section class="text-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="col-sm-3 col-md-3 col-lg-2 clearfix">
                        <div class="price-block">
                            <div>
                                <img src="<?php echo get_template_directory_uri() ?>/images/sheet.png" alt="Icon">
                            </div>
                            <ul class="price-block__list">
                                <li>
                                    <span>Срок:</span>
                                    <span>от <strong><?php the_field('days') ?></strong>х дней</span>
                                </li>
                                <li>
                                    <span>Цена:</span>
                                    <span>от <strong><?php the_field('price') ?></strong> руб.</span>
                                </li>
                            </ul>
                            <button type="button">Заказать</button>
                        </div>
                    </div>
                    <div class="col-sm-9 col-md-9 col-lg-6 qa__section clearfix">

                        <table class="table">
                            <tr>
                                <th><p class="qa__title qa__title--question">Вопрос</p></th>
                                <th><p class="qa__title qa__title--exclamation">Ответ</p></th>
                            </tr>
	                        <?php

	                        // check if the repeater field has rows of data
	                        if( have_rows('q_a') ): $i = 1;
		                        ...
		                        while ( have_rows('q_a') ) : the_row(); ?>
                                    ...
                                    <tr>
                                        <td class="qa__item">
					                        <?php echo $i . ". ";  the_sub_field('question')?>
                                        </td>
                                        <td class="qa__item">
                    ...
                    <div class="col-md-12 col-lg-4 single__pricelist-outer clearfix">
    ...
    <section class="text-section">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-section__content">
