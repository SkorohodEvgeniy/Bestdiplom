...
<!--New Page-->
 <section class="help-write">
		  ...
		  <?php 
			...
			<?php else: ?>
			<img
            src="<?php echo get_bloginfo("template_url"); ?>/media/images/help-face2.png"
            alt="face"
            width="671"
            height="529"
            class="face-img"
          ...
          <div class="container">
            <div class="help-write__content">
				...
				<?php if( get_field("_strapline_text") ) : ?>
					  <h1 class="title"> 
					...
					<?php else: ?>
						<h1 class="title">
							Помощь в написании курсовых, дипломных, контрольных и других
							работ<span> от 40 ХЗ/стр</span>
					  </h1>
					  <p class="subtitle">
							План, презентация, речь, отчет об уникальности и правки -
							<b>бесплатно!</b>
						  </p>
						  <p class="two-subtitle">
							Укажите свой "дедлайн" - - беремся только за те работы, которые
							гарантированно сделаем вовремя
						  </p>
				<?php endif; ?>	
              ...
              <ul class="items-lists">
				...
				<?php else: ?>
							<li>
                  <img
                    src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/need.png"
                    alt="need"
                    width="50"
                    height="50"
                  />
                  <div class="list-content">
                    <h5>То что надо!</h5>
                    <p>
                      После написания, все работы проверяются на соответствие
                      требованиям вашего ВУЗа, ГОСТам и нормам Антиплагиата
                    </p>
                  </div>
                </li>
                <li>
                  <img
                    src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/time.png"
                    alt="time"
                    width="50"
                    height="50"
                  />
                  <div class="list-content">
                    <h5>Точно в срок!</h5>
                    <p>
                      Выполнение срочных работ - от 1 дня. Полная оплата после
                      ознакомления с частью работы. Предоплата всего 30%.
                    </p>
                  </div>
                </li>
                <li>
                  <img
                    src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/armor.png"
                    alt="armor"
                    width="50"
                    height="50"
                  />
                  <div class="list-content">
                    <h5>С гарантией!</h5>
                    <p>
                      Вернем деньги, если работа не соответствует изначальному
                      заданию (теме, требованиям ВУЗа, оригинальности и.т.д.)
                    </p>
                  </div>
                </li>
          ...
          <div class="container">
            <div class="calculator__content">
              ...
              <div class="calculator-form">
                ...
                <div class="total calc-services">
                  <ul>
                    <li>
                      <div class="pic_calc">
                        <img
                          src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/calc/1.png"
                          alt="1"
                          width="24"
                          height="24"
                        />
                    ...
                    <li>
                      <div class="pic_calc">
                        <img
                          src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/calc/2.png"
                          alt="2"
                          width="24"
                          height="24"
                        />
                    ...
                    <li>
                      <div class="pic_calc">
                        <img
                          src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/calc/3.png"
                          alt="3"
                          width="24"
                          height="24"
                        />
                    ...
                    <li>
                      <div class="pic_calc">
                        <img
                          src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/calc/4.png"
                          alt="4"
                          width="24"
                          height="24"
                        />
                      ...
                      <div class="text_box">
                        <p><b>Автор:</b></p>
                        <p>Преподаватель или кандидат наук</p>
                      </div>
                    </li>
                    <li>
                      <div class="pic_calc">
                        <img
                          src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/calc/5.png"
                          alt="5"
                          width="24"
                          height="24"
                        />
                    ...
                    <li>
                      <div class="pic_calc">
                        <img
                          src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/calc/6.png"
                          alt="6"
                          width="24"
                          height="24"
                        />
                      ...
                      <div class="text_box">
                        <p><b>Бесплатные материалы:</b></p>
                        <p>План, презентация, речь, отчет о уникальности</p>
                      </div>
                    </li>
                    <li>
                      <div class="pic_calc">
                        <img
                          src="<?php echo get_bloginfo("template_url"); ?>/media/images/icons/calc/7.png"
                          alt="7"
                          width="24"
                          height="24"
                        />
                      ...
                      <div class="text_box">
                        <p><b>Оригинальность:</b></p>
                        <p>от 60% (достаточно для большинства ВУЗов)</p>
                      </div>
                    </li>
                  </ul>
                </div>
...
<section class="how-work">
          ...
          <div class="container">
            <div class="how-work__inner">
              ...
              <div class="how-work__text-info">
                ...
                <button class="btn btn--size-md how-work__text-into-btn">
                  Заполните форму
                </button>
              </div>
            </div>
                    ...
                    if (have_rows('last_work', 'option')):
                        ...
                        while (have_rows('last_work', 'option')) : the_row(); ?>
							...
							<tr>
							  ...
							  <td><?php the_sub_field('_data_work'); ?></td>
          ...
          <div class="container">
            <div class="join-us__inner">
              <div class="join-us__text-box">
                ...
                >
                  Присоединяйтесь к самому студенческому сообществу в
                  <span class="instagram-gradient-text">Instagram</span>
                </h2>
                <p class="join-us__text">
                  Полезная информация, юмор, зарядка для ума, розыгрыши призов и
                  многое другое, что нельзя пропустить :)
                </p>
                <a href="<?php the_field("_join_us_link", 'option'); ?>" class="btn join-us__btn">Подписаться</a>
              </div>
              <div class="join-us__img-box">
                <img
                  src="<?php echo get_bloginfo("template_url"); ?>/media/images/join-us.png"
                  alt="join us"
                  width="518"
                  height="447"
                  class="join-us__img"
		...
		<section class="seo-text">
          ...
          <div class="container">
			...
			<h2 class="section-heading section-heading--decor-left seo-text__section-heading"><?php the_title() ; ?></h2>
        ...
        <div class="container course-section">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="text-section__title">Написание дипломных работ по предметам</h2>
                </div>
                <div class="link-wrepper">
                    <ul>
                        <?php
                        if (have_posts()) { // если имеются записи в блоге.
                            $all = query_posts('cat=3&posts_per_page=50');
                            foreach ($all as $item) {
                             
                                if (get_field('home_bottom_page', $item->ID) == "yes") {
                                    $title = get_field('home_bottom_page_title', $item->ID);
                                    echo "<li><a href='" . get_permalink($item->ID) . "' title='" . $title . "'>" . $title . "</a></li>";
