...
const inpBtn = document.querySelector(".btn-input").cloneNode(1);
...
function hambHandler(e) {
  ...
  menuBtn.appendChild(inpBtn);


// Код для закрытия меню при нажатии на ссылку

const links = document.querySelector(".hamb__field");
const mobBtnVal = document.querySelector(".popup .mob_btn-val");
console.log(mobBtnVal);

	if( links.classList.contains('active') ) {
		
	links.addEventListener("click", closeOnClick);

	}
mobBtnVal.addEventListener("click", closeOnClick);
...
/*Delete #hash from URL and scroll*/
