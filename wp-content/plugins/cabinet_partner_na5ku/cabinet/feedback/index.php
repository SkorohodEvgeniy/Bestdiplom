...
$form['form-1'] = array(
    ...
    'cfg' => array(
        'charset' => 'utf-8',
        'subject' => 'na5ku.com.ua - заказать звонок',
        'title' => 'Заголовок в теле письма',
        'ajax' => true,
        'validate' => true,
        'from_email' => 'noreply@email.com',
        'from_name' => 'noreply',
        'to_email' => 'ferdasfarmazone@gmail.com',
		...
		<div class="modal-thank">
			<p>Спасибо!</p>
			<p><span>Ваша заявка принята!</span></p>
			<p>Наш специалист</p>
			<p>свяжется с вами</p>
			<p>в течение рабочего дня!</p>
		</div>
    ',
...
$form['form-2'] = array(
    ...
    'cfg' => array(
        'charset' => 'utf-8',
        'subject' => 'na5ku.com.ua - заказать работу',
        'title' => 'Заголовок в теле письма',
        'ajax' => true,
        'validate' => true,
        'from_email' => 'noreply@email.com',
